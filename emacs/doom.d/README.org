...
#+html: <img max-width="100%" src="images/editor-comparison.png" />
...
*** Dashboard
#+html: <img max-width="100%" src="images/dashboard.png" />

*** Org mode

#+html: <img max-width="100%" src="images/org-mode.png" />

*** Python mode

#+html: <img max-width="100%" src="images/python-mode.png" />
** Some helper guide
...
#+html: <img max-width="100%" src="https://zzamboni.org/post/beautifying-org-mode-in-emacs/emacs-init-propfonts-light.png" />
